...
This tool is a .NET 10 console app/a dotnet tool providing a thin .NET 10 wrapper around an IKVM cross-compiled version of Saxon HE 12.10 Java to run XQuery 3.1.
...
Please understand that this is my own experiment, it uses the official Saxon HE 12.10 release, but the integration with IKVM and IKVM Maven is an experimental work of my own, not in any way an officially tested and supported product by Saxonica, the company that has produced Saxon.
...
Understand that this is work in progress and kind of experimental, I don't have access to a complete test suite of unit tests to rigorously test this, I nevertheless feel it can be useful for folks to at least know about this option to run [XQuery 3.1](https://www.w3.org/TR/xquery-31/) with .NET 10, without depending on the so far commercial only SaxonCS 12 from Saxonica.
