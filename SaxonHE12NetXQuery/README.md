...
This tool is a .NET 6/8/9 console app/a dotnet tool providing a thin .NET 6/8/9 wrapper around an IKVM cross-compiled version of Saxon HE 12.5 Java to run XQuery 3.1.
