# Thin .NET 6 console app/dotnet tools around IKVM cross-compiled .NET version of Saxon-HE 12.1 Java
These two tools are .NET 6 console apps/a dotnet tools providing a thin .NET 6 wrapper around an IKVM cross-compiled version of Saxon HE 12.1 Java to perform XSLT 3.0 transformations or to run XQuery 3.1.
