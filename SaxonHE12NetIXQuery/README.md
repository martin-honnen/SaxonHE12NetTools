# Thin .NET 8 console app/dotnet tool around IKVM cross-compiled .NET version of Saxon-HE 12.9 Java, extended with CoffeeSacks Invisible XML extension library 3.2.9
