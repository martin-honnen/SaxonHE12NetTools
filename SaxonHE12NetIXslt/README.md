# Thin .NET 10 console app/dotnet tool around IKVM cross-compiled .NET version of Saxon-HE 12.10 Java, extended with CoffeeSacks 3.3.14 Invisible XML extension
