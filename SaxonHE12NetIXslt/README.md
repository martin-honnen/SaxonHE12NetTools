# Thin .NET 6 console app/dotnet tool around IKVM cross-compiled .NET version of Saxon-HE 12.3 Java, extended with CoffeeSacks 3.0.0 Invisible XML extension
