...
This tool is a .NET 6/8 console app/a dotnet tool providing a thin .NET 6 wrapper around an IKVM cross-compiled version of Saxon HE 12.4 Java to perform XSLT 3.0 transformations.
...
Install with e.g. 
```
dotnet tool install --global SaxonHE12NetXslt --version 12.4.8.8-pre.1
```
