﻿# Thin .NET 8 console app/dotnet tool around IKVM cross-compiled .NET version of Saxon-HE 12.6 Java
...
Install with e.g. 
```
dotnet tool install --global SaxonHE12NetXslt --version 12.6.0
```
